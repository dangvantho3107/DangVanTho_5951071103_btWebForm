...
namespace DangVanTho_5951071103_btWebForm.Models
{
    public class db
    {
        SqlConnection conn = new SqlConnection(@"Data Source=PC\SQLEXPRESS01;Initial Catalog=DemoCRUD;Integrated Security=True");
        //Select
